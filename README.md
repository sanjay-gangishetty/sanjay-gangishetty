...
[![My Skills](https://skillicons.dev/icons?i=aws,java,html,css,js,jquery,bootstrap,tailwindcss,express,nodejs,react,vite,mysql,sqlite,mongodb,prisma,c,cpp,php,py,flask,linux,docker,git,github,vim,bash,md,postman)](#)
